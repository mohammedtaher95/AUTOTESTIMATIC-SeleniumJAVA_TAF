...
public class AlertHandlingTest {
    ...
    public void checkAlerts(){
        ...
        new HomePage(driver.get()).openJSAlertsPage()
                .checkThatJSAlertsPageShouldBeOpened()
                .clickOnJSAlertButtonAndAcceptAlert()
                .checkThatJSAlertIsAccepted()
                .clickOnJSConfirmButtonAndAcceptAlert()
                .checkThatJSConfirmIsAccepted()
                .clickOnJSPromptButtonAndAcceptAlert()
                .checkThatJSPromptIsAccepted();
